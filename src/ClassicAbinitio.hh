...
#if 1
	void Ect_withoutdp_new(core::pose::Pose decoy, double &sumEct, double **contact1, double **contact2, int seq_length);
	double E_total(core::pose::Pose pose, double Edp, double Ect, double w1, double w2, double w3);
	bool whether_accept_new(double Etrial_energy, double Etarget_energy);
	bool boltzmann_accept_new(double Etrial_energy, double Etarget_energy);

	void aftermerge(core::pose::Pose *mypose,int start,int end, core::pose::Pose newpose[], int seq_len,double **contact1, double **contact2, double **contact3,double **contact4,double spaceAveEvalue,double spaceStdEvalue,double minAve,double minStd,double blend_contact1,double blend_contact2,double blend_contact3,double blend_contact4,double weight1,double weight2,double weight3,double weight4);
	void aftermerge_sort(core::pose::Pose *mypose,int start,int end, core::pose::Pose newpose[], int seq_len,double **contact1, double **contact2, double **contact3,double **contact4,double spaceAveEvalue,double spaceStdEvalue,double minAve,double minStd,double blend_contact1,double blend_contact2,double blend_contact3,double blend_contact4,double weight1,double weight2,double weight3,double weight4);
	double normalizationAveandStd(double E1, double E2, double E3, double E4,double spaceAveEvalue,double spaceStdEvalue,double minAve,double minStd,double weight1,double weight2,double weight3,double weight4);
	double energyDesignByMHH(core::pose::Pose decoy, double **contact, int seq_length, double blend_contact);

	void Eaftermerge_sort(core::pose::Pose *Epose,int start,int end, core::pose::Pose newpose[], int seq_length , double **contact);
	void Eaftermerge(core::pose::Pose *Epose,int start,int end, core::pose::Pose newpose[], int seq_length, double **contact);
